...
const CateringBooking = () => {
  ...
  const handleBooking = (e) => {
    ...
    setTimeout(() => {
      ...
      setFormData({
        name: '', phone: '', eventType: 'Wedding', guests: '', date: '', location: '', requirements: ''
      });
      setSelectedItems({});
    ...
    <div className="page-padding">
      ...
      <div className="container" style={{ maxWidth: '1000px' }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 style={{ color: 'var(--color-dark-green)', marginBottom: '16px' }}>Waalai Catering & Menu</h1>
        ...
        <div id="booking-form" style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <form onSubmit={handleBooking} style={{ 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
              ...
              <div>
                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600, color: 'var(--color-earth-brown)' }}>Phone Number</label>
                <input type="tel" name="phone" className="input-field" required value={formData.phone} onChange={handleChange} placeholder="93677 57775" style={{ border: '1px solid rgba(76,171,76,0.3)', backgroundColor: 'var(--color-warm-sand)' }} />
              </div>
            </div>
