...
const slides = [
  {
    ...
    titleHighlight: <><WaalaiText scale={1.1} /> Heritage</>,
    description: "Authentic and traditional home-style flavors. Prepared fresh with high hygiene, without any artificial ingredients.",
    actionText: "Order Non-Veg",
    actionLink: "/order?type=nonveg",
    subtitleColor: "var(--color-gold-accent)",
    highlightColor: "var(--color-vibrant-leaf)"
  },
  {
    bgImage: bannerimg2,
    featuredImage: bannerimg2,
    subtitle: "Banana Leaf Serving",
    titlePrimary: "Fresh",
    titleHighlight: "Banana Leafs",
    description: "Experience the ultimate traditional dining. Prepared fresh with high hygiene, without any artificial ingredients.",
  ...
  },
  {
    ...
    subtitle: <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}><WaalaiText scale={1.1} /> Catering</div>,
    titlePrimary: "Perfected with",
    titleHighlight: "Traditional Care",
    description: "Elevate your celebrations with our premium catering. Prepared fresh with high hygiene, without any artificial ingredients.",
...
const Home = () => {
  ...
  const [activeMapBranch, setActiveMapBranch] = useState('main'); // 'main' or 'anna'
    ...
    <div style={{ overflowX: 'hidden' }}>
          ...
          <div className="hero-grid">
            ...
            <div>
              <span className="slide-fade-in" style={{ 
                display: 'inline-flex', 
                alignItems: 'center',
                color: slides[currentSlide].subtitleColor || 'var(--color-gold-accent)', 
                fontSize: '1.2rem', 
                fontWeight: 800, 
              ...
              <h1 className="slide-fade-in" style={{ 
                ...
                <span style={{ color: slides[currentSlide].highlightColor || 'var(--color-banana-leaf)' }}>{slides[currentSlide].titleHighlight}</span>
              </h1>
      ...
      <section ref={addToRefs} className="section-padding" style={{ backgroundColor: '#ffffff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <h2 style={{ color: 'var(--color-dark-green)', fontSize: '2.8rem' }}>உணவே மருந்து (Food as Medicine)</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
            <div className="glass mobile-small-padding" style={{ padding: '40px 24px', textAlign: 'center', borderRadius: '24px', borderTop: '4px solid var(--color-primary-green)', backgroundColor: 'var(--color-warm-sand)' }}>
              ...
              <p style={{ color: 'var(--color-earth-brown)' }}>Sourced from local farms. Zero preservatives and Absolutely no hidden flavor and enhancers.</p>
            </div>
            <div className="glass mobile-small-padding" style={{ padding: '40px 24px', textAlign: 'center', borderRadius: '24px', borderTop: '4px solid var(--color-gold-accent)', backgroundColor: 'var(--color-warm-sand)' }}>
              ...
              <p style={{ color: 'var(--color-earth-brown)' }}>Our vibrant colors come strictly from pure turmeric and authentic sun-dried chillies & waalai home made masalas.</p>
            </div>
      ...
      <section ref={addToRefs} className="section-padding" style={{ backgroundColor: '#ffffff' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '2.8rem', color: 'var(--color-dark-green)', marginBottom: '24px' }}><WaalaiText style={{height: '1em'}}/> waalai cares for the differently abled</h2>
          <p style={{ fontSize: '1.3rem', maxWidth: '800px', margin: '0 auto 40px', color: 'var(--color-earth-brown)' }}>
            True hospitality knows no boundaries. We are proud to offer a flat **25% discount** .
          </p>
          <div style={{ 
      ...
      <section ref={addToRefs} className="section-padding" style={{ backgroundColor: 'var(--color-warm-sand)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <h2 style={{ color: 'var(--color-dark-green)', fontSize: '3rem', marginTop: '10px' }}>What our customers say</h2>
          </div>
              ...
              <div style={{ display: 'grid', gap: '20px' }}>
                 ...
                 <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', padding: '24px', borderRadius: '16px', backgroundColor: 'var(--color-warm-sand)' }}>
                   ...
                   <div>
                     ...
                     <p style={{ color: 'var(--color-text-light)', margin: 0 }}>No:187, 80 Feet Rd, opp. DD Designs, <br/>Near Ambiga Cinemas, Anna Nagar, <br/>Madurai 625020.</p>
                   </div>
                 </div>
              </div>
            </div>
      ...
      <section ref={addToRefs} id="contact" className="section-padding" style={{ backgroundColor: 'var(--color-warm-sand)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
              ...
              <div className="glass" style={{ padding: '32px', display: 'flex', alignItems: 'flex-start', gap: '16px', borderRadius: '16px', backgroundColor: 'white', borderLeft: '4px solid var(--color-primary-green)' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--color-earth-brown)', fontSize: '0.9rem' }}>
                    <strong>Anna Nagar:</strong> No:187, 80 Feet Rd, opp. DD Designs, Near Ambiga Cinemas, Anna Nagar, Madurai, Tamil Nadu 625020.
                  </p>
                </div>
              </div>
            ...
            {/* Map Section */}
            <div className="glass" style={{ padding: '24px', minHeight: '450px', display: 'flex', flexDirection: 'column', gap: '20px', borderRadius: '16px', backgroundColor: 'white' }}>
              <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                <button 
                  onClick={() => setActiveMapBranch('main')}
                  style={{
                    flex: 1,
                    padding: '12px',
                    borderRadius: '50px',
                    border: 'none',
                    backgroundColor: activeMapBranch === 'main' ? 'var(--color-primary-green)' : 'var(--color-warm-sand)',
                    color: activeMapBranch === 'main' ? 'white' : 'var(--color-dark-green)',
                    fontWeight: 700,
                    cursor: 'pointer',
                ...
                <button 
                  onClick={() => setActiveMapBranch('anna')}
                  style={{
                    flex: 1,
                    padding: '12px',
                    borderRadius: '50px',
                    border: 'none',
                    backgroundColor: activeMapBranch === 'anna' ? 'var(--color-primary-green)' : 'var(--color-warm-sand)',
                    color: activeMapBranch === 'anna' ? 'white' : 'var(--color-dark-green)',
                    fontWeight: 700,
                    cursor: 'pointer',
                    transition: 'all 0.3s ease'
                  }}
              ...
              <div style={{ flex: 1, position: 'relative', borderRadius: '12px', overflow: 'hidden', border: '1px solid rgba(0,0,0,0.1)' }}>
                {activeMapBranch === 'main' ? (
                  <iframe 
                  ...
                  <iframe 
                    src="https://maps.google.com/maps?q=No:187,+80+Feet+Rd,+Near+Ambiga+Cinemas,+Anna+Nagar,+Madurai,+Tamil+Nadu+625020&t=&z=16&ie=UTF8&iwloc=&output=embed" 
                    width="100%" 
                    height="100%"
                    style={{ border: 0 }} 
                    allowFullScreen="" 
            ...
            <div style={{ flex: '1 1 300px', display: 'flex', justifyContent: 'center', zIndex: 1 }}>
              <div style={{ 
                ...
                <p style={{ color: 'var(--color-earth-brown)', fontSize: '1rem', marginBottom: '32px', lineHeight: 1.6 }}>
                  No:187, 80 Feet Rd, opp. DD Designs, Near Ambiga Cinemas, Madurai 625020.
                </p>
