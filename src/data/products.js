import nonVegBiryaniImg from '../assets/images/1kgbiryani/1kg Meat Biryani ,Fried Rice.jpg';
import vegBiryaniImg from '../assets/images/1kgbiryani/1kg Mushroom , Veg Biryani.jpg';
...
export const products = [
  // 1KG Non-Veg
  {
    ...
    description: "Rich, slow-cooked mutton in to authentic traditional gravy. Choice of Fry/Semi-Gravy available.",
    price: 1550,
  ...
  },
  {
    ...
    description: "Shredded mutton tossed with special spices and traditional style.",
    price: 1550,
    category: "1KG Non-Veg",
    isVeg: false,
